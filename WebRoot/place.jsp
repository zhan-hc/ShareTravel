      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-9 text-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
            ...
            <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Route</h1>
          </div>
        </div>
      </div>
    </div>
        	...
        	<div class="col-lg-3 sidebar order-md-last ftco-animate">
        		<div class="sidebar-wrap ftco-animate">
        			...
        			<form action="#">
		              ...
		              <div class="form-group">
		                <input type="button" value="Search" class="btn btn-primary py-3 px-5">
		              </div>
		            </div>
	            </form>
        		</div>
          	...
          	<div class="row">
          		<s:iterator value="introduces" var="introduce">
          				<div class="col-sm col-md-6 col-lg-4 ftco-animate">
		    				<div class="destination"><!-- avascript:routeclick('<s:property value="#introduce.tid"/>'.slice(4)-1) -->
		    					<a href="http://localhost:8080/ShareTravel/introduce_Detail?introduce.tid=<s:property value="#introduce.tid"/>" class="img img-2 d-flex justify-content-center align-items-center"
		    						style="background-image: url(<s:property value="#introduce.images"/>);" >
		    					...
		    					<div class="text p-3">
		    						...
		    						<p class="bottom-area d-flex">
		    							...
		    							<span class="ml-auto"><a href="http://localhost:8080/ShareTravel/introduce_Detail?introduce.tid=<s:property value="#introduce.tid"/>">Discover</a></span>
		    						</p>
		    					</div>
		    				</div>
		    			</div>
